    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">Olivet Storehouse</h1>
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Shop our collection of church merchandise, including apparel, books, music, and more.
                </p>
              </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Check out our latest additions to the Olivet Storehouse collection.
              </p>
            </div>
          </div>
          <NewArrivalsSlider />
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Discover our most popular items from the Olivet Storehouse collection.
              </p>
            </div>
          </div>
          <FeaturedProducts />
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-primary text-primary-foreground">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Ablaze Youth Program</h2>
              <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Shop merchandise from our annual youth program, featuring items from current and previous years.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            <Card className="bg-background">
              <CardContent className="p-6">
                <div className="flex flex-col items-center space-y-4">
                  <Image
                    src="/images/ablaze-2024-logo.png"
                    width={200}
                    height={200}
                    alt="Ablaze 2024"
                    className="rounded-lg object-cover"
                  ...
                  <div className="space-y-2 text-center">
                    ...
                    <p className="text-muted-foreground">This year's collection</p>
                  </div>
            ...
            <Card className="bg-background">
              <CardContent className="p-6">
                <div className="flex flex-col items-center space-y-4">
                  <Image
                    src="/images/ablaze-2023-logo.png"
                    width={200}
                    height={200}
                    alt="Ablaze 2023"
                    className="rounded-lg object-cover"
                  ...
                  <div className="space-y-2 text-center">
                    ...
                    <p className="text-muted-foreground">Last year's collection</p>
                  </div>
            ...
            <Card className="bg-background">
              <CardContent className="p-6">
                <div className="flex flex-col items-center space-y-4">
                  <Image
                    src="/images/ablaze-archive-logo.png"
                    width={200}
                    height={200}
                    alt="Ablaze Archive"
                    className="rounded-lg object-cover"
                  ...
                  <div className="space-y-2 text-center">
                    ...
                    <p className="text-muted-foreground">Collections from previous years</p>
                  </div>
            ...
            {[
              {
                ...
                image: "/images/ablaze-2024-logo.png",
                date: "March 15, 2024",
                id: 1,
              },
              {
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Browse our merchandise by category to find exactly what you're looking for.
              </p>
            </div>
          </div>
          <ProductCategories />
