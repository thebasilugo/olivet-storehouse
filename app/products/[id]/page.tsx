...
const getProductById = (id: any) => {
	...
	const allProducts = [
		...
		},
		{
			...
			category: "Posters",
			description:
				"Inspirational scripture poster for your home or office. High-quality print on premium paper.",
			sizes: ["18x24", "24x36"],
			colors: ["Standard"],
			inStock: true,
			stockLevel: 45,
		...
		},
		{
			...
			category: "Shirts",
			description:
				"Comfortable hoodie with the Olivet Church logo. Perfect for cooler weather and casual wear.",
			sizes: ["S", "M", "L", "XL", "XXL"],
		...
		},
		{
			...
			description:
				"Handcrafted bracelet with inspirational message. A reminder to pray throughout your day.",
			sizes: ["One Size"],
			colors: ["Brown", "Black"],
			inStock: true,
			stockLevel: 50,
		...
		},
		{
			...
			category: "Shirts",
			description:
				"Official t-shirt from the Ablaze 2024 youth program. Features the event theme and logo.",
			sizes: ["S", "M", "L", "XL", "XXL"],
			colors: ["Red", "Black"],
			inStock: true,
			stockLevel: 40,
		...
		},
		{
			...
			category: "Books",
			description:
				"Comprehensive guide for worship leaders. Includes tips, song suggestions, and spiritual guidance.",
			sizes: ["Standard"],
			colors: ["Standard"],
			inStock: true,
			stockLevel: 12,
		...
		},
		{
			...
			category: "Accessories",
			description:
				"Stainless steel water bottle with Olivet logo. Keeps drinks cold for 24 hours or hot for 12 hours.",
			sizes: ["20oz"],
		...
		},
		{
			...
			category: "Posters",
			description:
				"Commemorative poster from Ablaze 2023. A great memento from last year's youth program.",
			sizes: ["18x24"],
			colors: ["Standard"],
			inStock: true,
			stockLevel: 8,
		...
		},
		{
			...
			category: "Accessories",
			description:
				"Set of 52 cards with key scripture verses. Perfect for memorization and daily reflection.",
			sizes: ["Standard"],
			colors: ["Standard"],
			inStock: true,
			stockLevel: 35,
	...
	const product: any = allProducts.find((p) => p.id === Number.parseInt(id));
					...
					<div className="relative">
						...
						{product.stockLevel === 0 && (
							<div className="absolute inset-0 bg-background/80 flex items-center justify-center rounded-lg">
								<Badge className="text-lg py-2 px-4 bg-destructive text-destructive-foreground">
									Out of Stock
								</Badge>
							</div>
						)}
