  ...
  upcoming: [
    {
      ...
      category: "Bundles",
      comingSoon: true,
      description: "Special bundle including t-shirt, cap, and exclusive items.",
      sizes: ["S", "M", "L", "XL"],
      colors: ["Standard"],
    },
    {
      ...
      category: "Books",
      comingSoon: true,
      description: "Journal with devotionals and space for notes from Ablaze 2024.",
      sizes: ["Standard"],
      colors: ["Standard"],
    },
  ],
  ...
  return (
    <div className="container px-4 md:px-6 py-8">
      <div className="flex flex-col items-center text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4">Ablaze Youth Program</h1>
                ...
                <div className="relative">
                  ...
                  {product.comingSoon && (
                    <div className="absolute inset-0 bg-background/80 flex items-center justify-center">
                      <Badge className="text-lg py-2 px-4 bg-primary text-primary-foreground">Coming Soon</Badge>
                    </div>
                  )}
                </div>
                <CardContent className="p-4">
      ...
      <div className="mt-16">
        <h2 className="text-2xl font-bold tracking-tight mb-6">Ablaze Archive</h2>
              ...
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Browse the archive collection</p>
                  </div>
